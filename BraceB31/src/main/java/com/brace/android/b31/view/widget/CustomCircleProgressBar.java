...
public class CustomCircleProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if(a != null){
            outsideColor = a.getColor(R.styleable.CustomCircleProgressBar_outside_color, ContextCompat.getColor(context, R.color.colorPrimary));
            outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, MiscUtil.dipToPx(context, 60.0f));
            insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(context, R.color.white));
            progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color, ContextCompat.getColor(context, R.color.white));
            progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, MiscUtil.dipToPx(context, 30f));
            progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, MiscUtil.dipToPx(context, 10.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        @SuppressLint("DrawAllocation") RectF oval = new RectF(circlePoint - outsideRadius, circlePoint - outsideRadius, circlePoint + outsideRadius, circlePoint + outsideRadius);  //用于定义的圆弧的形状和大小的界限
