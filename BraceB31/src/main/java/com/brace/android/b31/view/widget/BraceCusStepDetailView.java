 ...
 * Date 2019/11/12
 */
public class BraceCusStepDetailView extends View {

    private static final String TAG = "BraceCusStepDetailView";
    ...
    public BraceCusStepDetailView(Context context) {
        super(context);
    }

    public BraceCusStepDetailView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context,attrs);
    }

    public BraceCusStepDetailView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context,attrs);
    }

    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.BraceCusStepDetailView);
        if(typedArray != null){
            pillarColor = typedArray.getColor(R.styleable.BraceCusStepDetailView_cus_steps_pillar_color, Color.GREEN);
            emptyColor = typedArray.getColor(R.styleable.BraceCusStepDetailView_cus_steps_empty_color,Color.WHITE);
