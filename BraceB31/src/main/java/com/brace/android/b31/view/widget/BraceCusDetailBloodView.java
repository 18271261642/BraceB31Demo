...
public class BraceCusDetailBloodView extends View {

    private static final String TAG = "BraceCusDetailBloodView";
    ...
    public BraceCusDetailBloodView(Context context) {
        super(context);
        initPaint();
        gestureDetector = new GestureDetector(context, new MyOnGestureListener());
    }

    public BraceCusDetailBloodView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initPaint();
        gestureDetector = new GestureDetector(context, new MyOnGestureListener());
    }

    public BraceCusDetailBloodView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
